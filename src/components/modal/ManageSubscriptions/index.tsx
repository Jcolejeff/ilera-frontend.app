...
const ManageSubscriptions = ({ trigger, triggerClassName }: IManageSubscriptions) => {
  ...
  return (
    <Dialog onOpenChange={(i) => setModalOpen(i)} open={modalOpen}>
      ...
      <DialogContent className='h-screen bg-white max-w-full overflow-x-hidden md:h-max  sm:w-[80vw] md:!max-w-[1000px] md:py-[7.91rem] md:px-12 lg:px-[6.29rem] overflow-auto'>
        <div className='flex flex-col w-full max-w-full  h-full '>
          ...
          <div className='w-full max-w-full flex flex-col gap-[0.87rem]'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-[1.25rem] mx-auto max-w-full'>
            ...
            <Input
              ...
              className='placeholder:text-primary-9/[0.38] w-full max-w-full'
            />
            ...
            <div className='flex items-center justify-between w-full gap-4'>
              ...
              >
                <span className='font-[500] text-[12px] md:text-[14px] leading-[24px] tracking-[0.4px] text-primary-1 whitespace-nowrap'>
                  <span className='hidden md:flex'>SUBSCRIBE</span> LATER
                </span>
                <Icon
                  name='arrowTo'
                  svgProp={{
              ...
              >
                <span className='font-[500] text-[12px] md:text-[14px] leading-[24px] tracking-[0.4px] text-white'>
                  CONTINUE
                </span>
                <Icon
                  name='arrowTo'
