          ...
          <div className='flex flex-col gap-[1.25rem] w-full'>
            ...
            <div className='flex justify-between'>
              <button
                ...
                className='w-[130px] h-[38px] mb-8 bg-primary-1 rounded-[6px] flex items-center justify-center gap-2 group hover:opacity-90 transition-all duration-300 ease-in-out'
              >
